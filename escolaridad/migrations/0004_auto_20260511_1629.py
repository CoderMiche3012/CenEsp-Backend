...
def cargar_municipios(apps, schema_editor):
    MunicipioEscuela = apps.get_model('escolaridad', 'MunicipioEscuela')
    ...
    objetos_municipios = [
        MunicipioEscuela(nombre=nombre) for nombre in nombres_municipios
    ]

    MunicipioEscuela.objects.bulk_create(objetos_municipios)

def eliminar_municipios(apps, schema_editor):
    MunicipioEscuela = apps.get_model('escolaridad', 'MunicipioEscuela')
    MunicipioEscuela.objects.all().delete()

class Migration(migrations.Migration):

    dependencies = [
        ('escolaridad', '0003_alter_municipioescuela_nombre'),
    ]

    operations = [
        migrations.RunPython(cargar_municipios, eliminar_municipios),
    ]
